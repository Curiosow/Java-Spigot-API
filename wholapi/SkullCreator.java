...
public class SkullCreator {
     ...
     * @return The head of the Player.
     */
    public static ItemStack itemFromUrl(String name, String url) {
        return itemWithUrl(name, createSkull(), url);
    }
     ...
     * @return The head of the Player.
     */
    public static ItemStack itemFromBase64(String name, String base64) {
        return itemWithBase64(name, createSkull(), base64);
    }
     ...
     */
    public static ItemStack itemWithUrl(String name, ItemStack item, String url) {
        notNull(item, "item");
        notNull(url, "url");

        return itemWithBase64(name, item, urlToBase64(url));
    }
     ...
     */
    public static ItemStack itemWithBase64(String name, ItemStack item, String base64)
    {
        notNull(item, "item");
    ...
    public static ItemStack itemWithBase64(String name, ItemStack item, List<String> lore, String base64)
    {
        notNull(item, "item");
        notNull(base64, "base64");
